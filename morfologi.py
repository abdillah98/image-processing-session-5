...
plt.subplot(1, 5, 1), plt.imshow(img_gray, cmap='gray'), plt.title('Gambar Asli')
plt.subplot(1, 5, 2), plt.imshow(erosion, cmap='gray'), plt.title('Erosi')
plt.subplot(1, 5, 3), plt.imshow(dilation, cmap='gray'), plt.title('Dilasi')
